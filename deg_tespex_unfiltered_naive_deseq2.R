...
res <- results(dds, contrast=list("genotype_OR_vs_FR", "genotype_ST_vs_FR"))     ## this is equivalent to OR/ST
...
write.xlsx (res, "striatum_deseq2_tespex_ORvsST_differential_expression.xlsx", rowNames=F)
