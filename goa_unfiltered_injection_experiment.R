...
deg <- read.xlsx ("striatum_deseq2_tespex_OTSHL1vsOTSHCTRL_injection_differential_expression.xlsx")
...
write.xlsx (gp_up, "striatum_deseq2_tespex_OTSHL1vsOTSHCTRL_injection_gene_ontology_analysis_up_genes.xlsx")
...
write.xlsx (gp_down, "striatum_deseq2_tespex_OTSHL1vsOTSHCTRL_injection_gene_ontology_analysis_down_genes.xlsx")
...
deg <- read.xlsx ("striatum_deseq2_tespex_STSHCTRLvsOTSHCTRL_injection_differential_expression.xlsx")
deg <- deg[deg$gene_type != "transposon", ]
...
gp_up <- gost(query = deg_up, organism = "mmusculus", numeric_ns = "ENTREZGENE_ACC", sources = c("GO:BP"), exclude_iea=TRUE, evcodes = TRUE, significant = TRUE,
              custom_bg = custom_bg, domain_scope = "custom_annotated")
gp_up <- gp_up$result[ ,c("term_id", "term_name", "significant", "p_value", "term_size", "query_size", "intersection_size", "parents", "intersection")]
write.xlsx (gp_up, "striatum_deseq2_tespex_STSHCTRLvsOTSHCTRL_injection_gene_ontology_analysis_up_genes.xlsx")
...
gp_down <- gost(query = deg_down, organism = "mmusculus", numeric_ns = "ENTREZGENE_ACC", sources = c("GO:BP"), exclude_iea=TRUE, evcodes = TRUE, significant = TRUE,
              custom_bg = custom_bg, domain_scope = "custom_annotated")
gp_down <- gp_down$result[ ,c("term_id", "term_name", "significant", "p_value", "term_size", "query_size", "intersection_size", "parents", "intersection")]
write.xlsx (gp_down, "striatum_deseq2_tespex_STSHCTRLvsOTSHCTRL_injection_gene_ontology_analysis_down_genes.xlsx")
...
deg <- read.xlsx ("striatum_deseq2_tespex_OTSHL1vsSTSHCTRL_injection_differential_expression.xlsx")
deg <- deg[deg$gene_type != "transposon", ]
...
gp_down <- gost(query = deg_down, organism = "mmusculus", numeric_ns = "ENTREZGENE_ACC", sources = c("GO:BP"), exclude_iea=TRUE, evcodes = TRUE, significant = TRUE,
              custom_bg = custom_bg, domain_scope = "custom_annotated")
gp_down <- gp_down$result[ ,c("term_id", "term_name", "significant", "p_value", "term_size", "query_size", "intersection_size", "parents", "intersection")]
write.xlsx (gp_down, "striatum_deseq2_tespex_OTSHL1vsSTSHCTRL_injection_gene_ontology_analysis_down_genes.xlsx")
